...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None  :
                self.ant = insect
            elif self.ant.can_contain(insect): ##self.ant.is_container and insect.is_container is False and 
                self.ant.contain_ant(insect)
            elif insect.can_contain(self.ant): ##insect.is_container and self.ant.is_container is False and 
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if isinstance(insect, QueenAnt) and insect.is_imposter is False:
                return
            # END Problem 13
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        if self.place.ant is not None and self.place.ant.blocks_path :
            return True
        elif self.place.ant is None or self.place.ant.blocks_path is False:
            return False
        # END Problem 7
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive, min_range = 0, max_range = float('inf')):
        ...
        beez = None
        counter = 0
        while current_place is not hive and not beez : 
            if min_range <= counter and counter <= max_range :
                beez = random_or_none(current_place.bees)
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        # if self.contained_ant or other.is_container is True:
        #     return False
        # return True
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        # BEGIN Problem 13
        self.armor = armor
        if QueenAnt.first_Queen is False:
    ...
    def action(self, colony):
        ...
        if self.is_imposter :
            ...
            while current_exit :
                if current_exit.ant and current_exit.ant.is_container and current_exit.ant.contained_ant :
                    if current_exit.ant.doubled is False:
                        current_exit.ant.damage = 2*current_exit.ant.damage
                        current_exit.ant.doubled = True
                    if current_exit.ant.contained_ant.doubled is False:
                        current_exit.ant.contained_ant.damage = 2*current_exit.ant.contained_ant.damage
                        current_exit.ant.contained_ant.doubled = True
                elif current_exit.ant and current_exit.ant.doubled is False:
                    current_exit.ant.damage = 2*current_exit.ant.damage
                    current_exit.ant.doubled = True
